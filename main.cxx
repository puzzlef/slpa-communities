...
void runExperiment(const G& x, int repeat) {
  ...
  for (int i=0, f=10; f<=10000; f*=i&1? 5:2, ++i) {
    ...
    {
      // Find SLPA using a single thread (1 labels).
      auto ak = slpaSeqStatic<1>(x, init, {repeat, tolerance});
